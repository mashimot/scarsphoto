...
Route::get('teste', function(Request $request ){
    ...
    $d = Media::getMediasGalleries($request);
});*/
...
Route::group([
    ...
    Route::get('medias/galleries', 'MediaGalleryController@index', [
        'as' => 'admin'
    ]);
    Route::get('medias/galleries/{gallery}', 'MediaGalleryController@show', [
        'as' => 'admin'
    ]);
    Route::get('medias/{media}/galleries/create', 'MediaGalleryController@create', [
        'as' => 'admin'
    ]);
    Route::put('medias/{media}/galleries', 'MediaGalleryController@update', [
        'as' => 'admin'
    ]);
    Route::get('medias/get_background_image', 'MediaController@getBackgroundImage', [
        'as' => 'admin'
    ]);
...
Route::get('/huehue', function(){
    return view('contact.hadouken');
});
Route::get('/myass', function(){
    return view('layouts.app-teste');
});
Route::get('/woo', function(){
    return view('layouts.app-joeys');
});
...
Route::group([
    ...
    Route::get('/hadouken', 'MainController@index');
    Route::get('{any}', function(){
        return view('index');
    })->where('any', '.*');
});
