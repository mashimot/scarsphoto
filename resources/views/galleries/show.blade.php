				...
				<div class="galleries_header galleries_header--with_cover">
					<div class="cover_photo">
						<div class="cover_wrap">
							<div class="image" style="background-image: url('{{ $gallery->media_url_gallery_cover }}'); transform: translate3d(0px, 0px, 0px);"></div>
...
$(document).ready(function(){
	...
	function paginate(pos = null, __this = null){
		$.ajax({
			url: `{{ route('galleries.show', $gallery->gallery_id) }}?page=${page}`,
			type: "GET",
			beforeSend: function(){
				$('.ajax-load').show();
			},
