            ...
            <div class="galleries_header galleries_header--with_cover">
                ...
                <div class="cover_photo">
                    <div class="cover_wrap">
                        <div class="image" :style="{ backgroundImage: `url(${gallery.media_url_gallery_cover})` }"></div>
                        <div class="galleries_header__nsfw_placeholder_content">
                            <div class="galleries_header__nsfw_placeholder_body">
                                <div class="galleries_header__nsfw_placeholder_message">Conteúdo Adulto</div>
                                <a class="button secondary" id="reveal_nsfw_cover">Mostre-me a Foto</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="gallery_details tab_navigation_wrapper">
                    <div class="gallery_details__title_wrapper">
                        <h1 class="gallery_details__title">{{ gallery.gallery_name }}</h1>
        ...
        methods: {
            ...
            getGalleries(pos = null, __this = null){
                ...
                if(vm.page <= vm.images.last_page){
                    vm.axios
                        .get(`${Laravel._BASE_URL}/api/portfolio/galleries/${this.gallery_id}?page=${this.page}`)
                        .then((response) => {
                            if(vm.page == 1){
